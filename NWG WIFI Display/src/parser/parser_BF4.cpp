#include "parser_BF4.h"  //#include "ExampleParser.h"
...
parser_BF4::parser_BF4(GameData *d) //ExampleListener::ExampleListener(GameData *d)
{
  lGame = d;
  resetStats();
}
...
void parser_BF4::key(String key) { //void ExampleListener::key(String key) {
...
void parser_BF4::value(String value) {//void ExampleListener::value(String value) {
  if (nextValGrab) {
...
void parser_BF4::startObject() {//void ExampleListener::startObject() {
  OBJECT_DEPTH_INDEX++;
}
void parser_BF4::endObject() {
  OBJECT_DEPTH_INDEX--;
}
void parser_BF4::startDocument() {
  OBJECT_DEPTH_INDEX = 0;
  //resetStats();  // ticketsFirstTeam = true;
}
void parser_BF4::endDocument() {}
void parser_BF4::whitespace(char c) {}
void parser_BF4::startArray() {}
void parser_BF4::endArray() {}

// consider utilizing 2nd argument for team #
// TODO: IS THIS EVEN NEEDED ANYMORE???
int parser_BF4::getTeamStat(uint8_t stat)
{
  switch (stat)
  {
    case STAT_KILLS_T1:
