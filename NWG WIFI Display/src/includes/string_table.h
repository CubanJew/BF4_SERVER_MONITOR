...
#define BF1_MAP_PASSCHENDAELE 26
#define BF1_MAP_RIVER_SOMME   27
#define BF1_MAP_CAPORETTO   28
#define BF1_MAP_LONDON_CALLING_RAIDERS  29
#define BF1_MAP_LONDON_CALLING_SCOURGE  30
#define BF1_MAP_RAZORS_EDGE 31
#define BF1_NUM_MAPS  31
...
INIT_CONST_STR_C(_BF1_MAP_PASSCHENDAELE, "Passchendaele");
INIT_CONST_STR_C(_BF1_MAP_RIVER_SOMME, "River Somme");
INIT_CONST_STR_C(_BF1_MAP_CAPORETTO, "Caporetto");
INIT_CONST_STR_C(_BF1_MAP_LONDON_CALLING_RAIDERS, "London Calling");
INIT_CONST_STR_C(_BF1_MAP_LONDON_CALLING_SCOURGE, "London Calling");
INIT_CONST_STR_C(_BF1_MAP_RAZORS_EDGE, "Razor's Edge");

const char* const STR_TABLE_BF1_MAPS[] = { _BF1_MAP_AMIENS,_BF1_MAP_ARGONNE_FOREST,_BF1_MAP_BALLROOM_BLITZ,_BF1_MAP_EMPIRES_EDGE,_BF1_MAP_FAO_FORTRESS,_BF1_MAP_FORT_DE_VAUX,_BF1_MAP_GIANTS_SHADOW,_BF1_MAP_MONTE_GRAPPA,_BF1_MAP_RUPTURE,_BF1_MAP_SINAI_DESERT,_BF1_MAP_SOISSONS,_BF1_MAP_ST_QUENTIN_SCAR,_BF1_MAP_SUEZ,_BF1_MAP_VERDUN_HEIGHTS,_BF1_MAP_NIVELLE_NIGHTS,_BF1_MAP_PRISE_DE_TAHURE,_BF1_MAP_LUPKOW_PASS,_BF1_MAP_VOLGA_RIVER,_BF1_MAP_TSARITSYN,_BF1_MAP_GALICIA,_BF1_MAP_BRUSILOV_KEEP,_BF1_MAP_ALBION,_BF1_MAP_ACHI_BABA,_BF1_MAP_CAPE_HELLES,_BF1_MAP_ZEEBRUGGE, _BF1_MAP_HELIGOLAND_BIGHT,_BF1_MAP_PASSCHENDAELE, _BF1_MAP_RIVER_SOMME, _BF1_MAP_CAPORETTO, _BF1_MAP_LONDON_CALLING_RAIDERS,_BF1_MAP_LONDON_CALLING_SCOURGE, _BF1_MAP_RAZORS_EDGE};
...
#define BF1_MODE_AIR_ASSAULT      8
#define BF1_NUM_MODES             8
...
INIT_CONST_STR_C(_BF1_MODE_AIR_ASSAULT,"AA");
const char* const STR_TABLE_BF1_MODES[] = {_BF1_MODE_CONQUEST,_BF1_MODE_DOMINATION,_BF1_MODE_FRONTLINES,_BF1_MODE_OPERATIONS,_BF1_MODE_RUSH,_BF1_MODE_SUPPLY_DROP,_BF1_MODE_TEAM_DEATHMATCH,_BF1_MODE_WAR_PIGEONS,_BF1_MODE_AIR_ASSAULT};
// ... END - BF1
